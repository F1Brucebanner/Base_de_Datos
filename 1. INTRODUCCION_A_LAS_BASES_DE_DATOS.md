...
### Qué es un dato? Es la representación abstracta o traducción de algo tangible al mundo de las computadoras y se hace por medio de números enteros, carácter, string(cadenas) etc. 

### ¿Qué es una base de datos? Es un conjunto de datos que tienen en común una o varias características y se concentran en una base.

### ¿Qué es un sistema gestor de bases de datos? Es el sistema mediante el cual se concentra la información que se encuentra dispersa o dividida. Correlaciona los datos entre si, para identificar de manera clara una información más detallada que se traduce en un informe.

### Aplicaciones de los sistemas de bases de datos Como ejemplo tenemos la información bancaria de los cuenta habientes. En un hotel el sistema de reservaciones. Una biblioteca identifica a quien le hizo prestamo de llibro(s), un almacen concentra su inventario disponible, etc.

### Propósito de los sistemas de bases de datos: La finalidad principal es tener concentrados datos encaminados a un fin y que nos permitan tomar decisiones de manera rápida.
